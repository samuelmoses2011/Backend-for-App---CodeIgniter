...
<section class="row text-center placeholders">
	<div class="row-fluid api_section">
		<h2 class="api_title">
			...
			<span class="text-danger" style="font-size: 20px;">/setGroupFriendAccept?id={GroupFriend ID}</span>
		</h2>
			...
			<table>
				...
				<tbody>
					...
					<tr class="">
						...
						<td> GroupFriend ID </td>
						<td>
							<input type="email" class="form-control" id="id" aria-describedby="emailHelp" placeholder="Group-Friend ID">
						</td>
					</tr>
					...
					<tr class="">
						...
						<td> Activity ID </td>
						<td>
							<input type="email" class="form-control" id="request_id" aria-describedby="emailHelp" placeholder="RequestID">
						</td>
					</tr>
	...
	$(document).ready(function() {
		...
		$('#try').on('click', function(event) {
			...
			var request_id = $("#request_id ").val();
	                ...
	                $.post( "<?php echo base_url();?>index.php/mobile/setGroupFriendAccept", {id:id, request_id:request_id}, function(data) {
