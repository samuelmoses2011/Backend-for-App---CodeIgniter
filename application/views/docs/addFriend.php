...
<section class="row text-center placeholders">
	<div class="row-fluid api_section">
		<h2 class="api_title">
			...
			<span class="text-danger" style="font-size: 20px;">/addFriend?uid={User ID}&friend_id={Friend ID}</span>
		</h2>
		<h4 class="api_subtitle text-secondary">Register friend data</h4>
			...
			<table>
				...
				<tbody>
					...
					<tr class="">
						...
						<td> Friend ID </td>
						<td>
							<input type="email" class="form-control" id="friend_id" aria-describedby="emailHelp" placeholder="Friend ID">
						</td>
					</tr>
	...
	$(document).ready(function() {
		...
		$('#try').on('click', function(event) {
			...
			var fid  = $("#friend_id").val();
	                ...
	                $.post( "<?php echo base_url();?>index.php/mobile/addFriend", {uid:uid, friend_id:fid}, function(data) {
