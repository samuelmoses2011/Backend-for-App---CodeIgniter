...
<section class="row text-center placeholders">
	<div class="row-fluid api_section">
		<h2 class="api_title">
			...
			<span class="text-danger" style="font-size: 20px;">/removeFriend?id={Friend ID}</span>
		</h2>
			...
			<table>
				...
				<tbody>
					...
					<tr class="">
						...
						<td> Friend ID </td>
						<td>
							<input type="email" class="form-control" id="id" aria-describedby="emailHelp" placeholder="Friend ID">
						</td>
					</tr>
	...
	$(document).ready(function() {
		...
		$('#try').on('click', function(event) {
			var id = $("#id").val();
	                ...
	                $.post( "<?php echo base_url();?>index.php/mobile/removeFriend", {id:id}, function(data) {
