...
<section class="row text-center placeholders">
	<div class="row-fluid api_section">
		<h2 class="api_title">
			...
			<span class="text-danger" style="font-size: 20px;">/searchUser?keyword={Keyword}</span>
		</h2>
			...
			<table>
				...
				<tbody>
					...
					<tr class="">
						...
						<td> Keyword </td>
						<td>
							<input type="email" class="form-control" id="keyword" aria-describedby="emailHelp" placeholder="Keyword">
						</td>
					</tr>
	...
	$(document).ready(function() {
		...
		$('#try').on('click', function(event) {
			var keyword = $("#keyword").val();
	                ...
	                $.post( "<?php echo base_url();?>index.php/mobile/searchUser", {keyword:keyword}, function(data) {
