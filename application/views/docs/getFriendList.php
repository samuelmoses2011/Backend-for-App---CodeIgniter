...
<section class="row text-center placeholders">
	<div class="row-fluid api_section">
		<h2 class="api_title">
			...
			<span class="text-danger" style="font-size: 20px;">/getFriendList?uid={User ID}&s_name={User Name}</span>
		</h2>
			...
			<table>
				...
				<tbody>
					...
					<tr class="">
						...
						<td> User Name </td>
						<td>
							<input type="email" class="form-control" id="s_name" aria-describedby="emailHelp" placeholder="User Name">
						</td>
					</tr>
	...
	$(document).ready(function() {
		...
		$('#try').on('click', function(event) {
			...
			var s_name = $("#s_name").val();
	                ...
	                $.post( "<?php echo base_url();?>index.php/mobile/getFriendList", {uid:uid, s_name:s_name}, function(data) {
