...
<section class="row text-center placeholders">
	<div class="row-fluid api_section">
		<h2 class="api_title">
			...
			<span class="text-danger" style="font-size: 20px;">/setUserDescription?uid={User ID}&description={Description}</span>
		</h2>
		<h4 class="api_subtitle text-secondary">Update user name</h4>
	...
	$(document).ready(function() {
		...
		$('#try').on('click', function(event) {
			...
			var description = $("#description").val();
	                ...
	                $.post( "<?php echo base_url();?>index.php/mobile/setUserDescription", {uid:uid, description:description}, function(data) {
