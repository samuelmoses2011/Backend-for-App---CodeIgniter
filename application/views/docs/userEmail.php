...
<section class="row text-center placeholders">
	<div class="row-fluid api_section">
		<h2 class="api_title">
			...
			<span class="text-danger" style="font-size: 20px;">/setUserMail?uid={User ID&mail={User Email}</span>
		</h2>
		<h4 class="api_subtitle text-secondary">Update user email</h4>
			...
			<table>
				...
				<tbody>
					...
					<tr class="">
						...
						<td>
							<input type="email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Last Name">
						</td>
					</tr>
	...
	$(document).ready(function() {
		...
		$('#try').on('click', function(event) {
			...
			var email  = $("#email").val();
	                ...
	                $.post( "<?php echo base_url();?>index.php/mobile/setUserEmail", {uid:uid, mail:email}, function(data) {
