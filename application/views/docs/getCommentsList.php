...
<section class="row text-center placeholders">
	<div class="row-fluid api_section">
		<h2 class="api_title">
			...
			<span class="text-danger" style="font-size: 20px;">/getCommentsList?community_id={Community ID}</span>
		</h2>
			...
			<table>
				...
				<tbody>
					...
					<tr class="">
						...
						<td> Community ID </td>
						<td>
							<input type="email" class="form-control" id="community_id" aria-describedby="emailHelp" placeholder="User ID">
						</td>
					</tr>
	...
	$(document).ready(function() {
		...
		$('#try').on('click', function(event) {
			var community_id = $("#community_id").val();
	                ...
	                $.post( "<?php echo base_url();?>index.php/mobile/getCommentsList", {community_id:community_id}, function(data) {
