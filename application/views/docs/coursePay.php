...
<section class="row text-center placeholders">
	<div class="row-fluid api_section">
		<h2 class="api_title">
			...
			<span class="text-danger" style="font-size: 20px;">/setCoursePay?uid={User ID}&course_id={Course ID}</span>
		</h2>
		<h4 class="api_subtitle text-secondary">Set Course Pay</h4>
		<p class="api_description">Set Course Pay</p>
	...
	$(document).ready(function() {
		...
		$('#try').on('click', function(event) {
			...
			var pid = $("#course_id").val();
	                ...
	                $.post( "<?php echo base_url();?>index.php/mobile/setCoursePay", {uid:uid, course_id:pid}, function(data) {
