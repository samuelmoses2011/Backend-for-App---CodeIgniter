...
<section class="row text-center placeholders">
	<div class="row-fluid api_section">
		<h2 class="api_title">
			...
			<span class="text-danger" style="font-size: 20px;">/getGoalList</span>
		</h2>
		<h4 class="api_subtitle text-secondary">Get Goal Lists</h4>
	...
	$(document).ready(function() {
		...
		$('#try').on('click', function(event) {
			var uid = "";
	                ...
	                $.post( "<?php echo base_url();?>index.php/mobile/getGoalList", {uid:uid}, function(data) {
