...
<section class="row text-center placeholders">
	<div class="row-fluid api_section">
		<h2 class="api_title">
			...
			<span class="text-danger" style="font-size: 20px;">/getModuleList?uid={User ID}&course_id={Course ID}</span>
		</h2>
	...
	$(document).ready(function() {
		...
		$('#try').on('click', function(event) {
			...
			var pid = $("#course_id").val();
	                ...
	                $.post( "<?php echo base_url();?>index.php/mobile/getModuleList", {uid:uid, course_id:pid}, function(data) {
