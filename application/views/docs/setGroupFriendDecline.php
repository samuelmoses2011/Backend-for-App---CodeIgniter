...
<section class="row text-center placeholders">
	<div class="row-fluid api_section">
		<h2 class="api_title">
			...
			<span class="text-danger" style="font-size: 20px;">/setGroupFriendDecline?id={Group-Friend ID}</span>
		</h2>
	...
	$(document).ready(function() {
		...
		$('#try').on('click', function(event) {
			...
			var request_id = $("#request_id ").val();
	                ...
	                $.post( "<?php echo base_url();?>index.php/mobile/setGroupFriendDecline", {id:id, request_id:request_id}, function(data) {
