...
<section class="row text-center placeholders">
	<div class="row-fluid api_section">
		<h2 class="api_title">
			...
			<span class="text-danger" style="font-size: 20px;">/removeGroupFriend?id={Group-Friend ID}</span>
		</h2>
	...
	$(document).ready(function() {
		...
		$('#try').on('click', function(event) {
			var id = $("#id").val();
	                ...
	                $.post( "<?php echo base_url();?>index.php/mobile/removeGroupFriend", {id:id}, function(data) {
