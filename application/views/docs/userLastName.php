...
<section class="row text-center placeholders">
	<div class="row-fluid api_section">
		<h2 class="api_title">
			...
			<span class="text-danger" style="font-size: 20px;">/setUserLastName?uid={User ID&lname={Last Name}</span>
		</h2>
	...
	$(document).ready(function() {
		...
		$('#try').on('click', function(event) {
			...
			var lName  = $("#last_name").val();
	                ...
	                $.post( "<?php echo base_url();?>index.php/mobile/setUserLastName", {uid:uid, lname:lName}, function(data) {
