...
<section class="row text-center placeholders">
	<div class="row-fluid api_section">
		<h2 class="api_title">
			...
			<span class="text-danger" style="font-size: 20px;">/getCommunityList?uid={User ID}</span>
		</h2>
	...
	$(document).ready(function() {
		...
		$('#try').on('click', function(event) {
			var uid = $("#uid").val();
	                ...
	                $.post( "<?php echo base_url();?>index.php/mobile/getCommunityList", {uid:uid}, function(data) {
